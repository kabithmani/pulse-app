...
import {
  Phone, CheckSquare, Users, AlertTriangle,
...
export default function ReportsPage() {
  ...
  async function fetchData() {
    ...
    // Fetch contacts for at-risk count
    ...
    setKpis([
      ...
      { label: 'Contacts at Risk', value: atRisk, delta: delta(atRisk, prevAtRisk), icon: <AlertTriangle size={18} />, color: '#F59E0B' },
    ]);
                    ...
                    <div key={i} className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          ...
                          style={{ background: stalenessColor(c.staleness) }}
                        />
                      </div>
                    </div>
                  ))}

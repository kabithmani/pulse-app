    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-6" style={{ background: 'var(--bg)' }}>
        <div className="w-full max-w-sm text-center">
          ...
          <h1 className="text-2xl font-semibold mb-3" style={{ color: 'var(--text-primary)' }}>Reset link sent</h1>
          <p className="text-base mb-8" style={{ color: 'var(--text-secondary)' }}>
            We emailed a password reset link to <strong>{email}</strong>. Check your inbox and click the link to set a new password.
          </p>
          <button onClick={() => { setResetSent(false); setIsForgotPassword(false); }}
            className="text-sm font-medium" style={{ color: 'var(--accent)' }}>
            Back to sign in
          </button>
        </div>
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-10">
          ...
          <p className="mt-2 text-sm" style={{ color: 'var(--text-secondary)' }}>
            {isForgotPassword ? 'Reset your password' : 'Your personal EA — free for 3 months'}
          </p>
        </div>
